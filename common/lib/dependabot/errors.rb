...
module Dependabot
  class DependabotError < StandardError
    ...
    # Remove any path segment from fury.io source
    ...
    def sanitize_message(message)
      ...
      path_regex =
        ...
        Regexp.escape(Utils::BUMP_TMP_FILE_PREFIX) + "[^/]*"
    ...
    def filter_sensitive_data(message)
      replace_capture_groups(message, BASIC_AUTH_REGEX, "<redacted>")
    end

    def sanitize_source(source)
      replace_capture_groups(source, FURY_IO_PATH_REGEX, "<redacted path>")
    end
