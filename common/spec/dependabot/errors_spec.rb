  ...
  describe "#message" do
    ...
    context "when source includes something that looks like a path" do
      ...
      it do
        is_expected.to eq(
          "The following source could not be reached as it requires authentication (and any provided details were "\
          "invalid or lacked the required permissions): npm.fury.io/<redacted path>"
        )
      end
    end
  end
...
RSpec.describe Dependabot::PrivateSourceTimedOut do
  ...
  describe "#message" do
    ...
    context "when source includes something that looks like a path" do
      ...
      it do
        is_expected.to eq(
          "The following source timed out: npm.fury.io/<redacted path>"
        )
      end
    end
  end
...
RSpec.describe Dependabot::PrivateSourceCertificateFailure do
  ...
  describe "#message" do
    ...
    context "when source includes something that looks like a path" do
      ...
      it do
        is_expected.to eq(
          "Could not verify the SSL certificate for npm.fury.io/<redacted path>"
        )
      end
    end
  end
